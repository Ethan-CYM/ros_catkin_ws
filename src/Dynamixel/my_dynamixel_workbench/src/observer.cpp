...
#include<ros/ros.h>
// #include<my_dynamixel_workbench/dxl_state.h>
//iostream
#include <iostream>
#include <fstream>
#include <sstream>
...
int main(int argc,char **argv)
{
	...
	int ini_pos = 1000;
	int dt = 300*1000;
	float K2 = -3.65917;	float K1 = -20.5966;
	int32_t 		limit_current = 450;	//2.69 [mA]

	std::ofstream CoeffRecoder("Z_obv_CoeffRecoder.txt");
  ...
  std::ofstream StatesRecoder("Z_obv_statusRecoder.txt");
  std::ofstream KRecoder("Z_obv_kRecoder.txt");
  std::ofstream JsumRecoder("Z_obv_JsumRecoder.txt");
