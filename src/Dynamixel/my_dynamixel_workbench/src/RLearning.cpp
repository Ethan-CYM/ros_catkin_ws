...
int main(int argc,char **argv)
{
	...
	std::ofstream CoeffRecoder("Z_RL_CoeffRecoder.txt");
...
//   dxl_wb.itemRead(ID,"Velocity_Limit",&limit_current);
  ...
  std::ofstream StatesRecoder("Z_RL_statusRecoder.txt");
  std::ofstream KRecoder("Z_RL_kRecoder.txt");
  std::ofstream JsumRecoder("Z_RL_JsumRecoder.txt");
