...
#include <ros/ros.h>
#include <cym_nodes/ServiceMsg.h> // this message type is defined in the current package
#include <iostream>
#include <string>
using namespace std;
...
int main(int argc, char **argv) {
    ...
    ros::NodeHandle n;
    ros::ServiceClient client = n.serviceClient<cym_nodes::ServiceMsg>("lookup_by_name");
    cym_nodes::ServiceMsg srv;
