...
int main(int argc, char *argv[])
{
  ...
  std::string tmpSerialNumA;
  char *serialNumA;
  n.getParam("serialNumA", tmpSerialNumA);
  serialNumA = (char*)tmpSerialNumA.c_str();

  FT_Sensor ft_sensor_A(serialNumA);

  ros::Publisher chatter_pub = n.advertise<geometry_msgs::WrenchStamped>("kw_ft_data", 1000);
